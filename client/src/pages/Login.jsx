    ...
    <>
      ...
      <style>
        {`
          ...
          input.nv-auth-input:-webkit-autofill:hover,
          input.nv-auth-input:-webkit-autofill:focus,
          input.nv-auth-input:-webkit-autofill:active {
            -webkit-box-shadow: 0 0 0 1000px #080b15 inset !important;
            box-shadow: 0 0 0 1000px #080b15 inset !important;
